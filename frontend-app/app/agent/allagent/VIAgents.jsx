	...
	return (
		<div className="relative mb-8">
			<div className="flex items-center justify-between mb-6">
				<h1 className="text-5xl text-black font-bold">Top agents in VI</h1>
			...
			<div className="font-bold text-md mt-8 text-gray-800">See all 1 Top agents in VI</div>
		</div>
	);
};

export default VIAgents;
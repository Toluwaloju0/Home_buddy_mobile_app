	...
	return (
		<div>
			...
			<div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
				...
				<div className="flex flex-col gap-4">
					...
					<div className="border-1 border-gray-200 rounded-md px-4 py-6">
						...
						<p className="text-md font-bold">N1,000,000/year</p>
					...
					<div className="border-1 border-gray-200 rounded-md px-4 py-6">
						...
						<p className="text-sm text-gray-400 leading-normal">This premium modern retail shop space is available for lease in heart of
							ikoyi, Lagos. Ideal for boutiques, saloons or small offices seeking visibility and accessibility.
						</p>
						<p className="text-sm text-gray-400 leading-normal">The unit offers 120sqm of flexible floor space with ample parking, modern fittings and is
							part of a secure, well maintained complex with 24/7 power supply.
						</p>
					</div>
				</div>
			...
			<div className="relative border-1 border-gray-200 mb-10 px-8 rounded-md">
				...
				<h1 className="my-10 text-xl font-bold text-black">see all 11 Ikoyi shops for rent</h1>
			</div>
		</div>
	)
}

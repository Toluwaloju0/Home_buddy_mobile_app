...
const properties = [
	{
		...
		title: "Mainland AShared 2 Bed Flat",
		price: "₦1,000,000/room/year",
		...
		<div>
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-10">
				<div className="mb-4 sm:mb-0">
					<h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Ikoyi apartments for rent</h1>
				</div>
			...
			<div className="relative mb-10">
				...
				>
					{visibleProperties.map((property, idx) => {
						...
						return (
							<Link href="/rent/sharedhomes/homes" 
							...
							>
								...
								<div className="relative h-48 sm:h-56 overflow-hidden">
									<img 
										...
										alt={property.title}
									/>
									<div className="text-blue-500 uppercase font-bold z-10 absolute top-3 left-3 bg-white px-4 py-1 rounded-xl">shared</div>
								</div>
								...
								<div className="flex justify-between border-t border-gray-100 p-4">
									...
									<div className="flex flex-row items-center gap-1">
										...
										<span className="font-medium text-gray-700 text-xs sm:text-sm">{property.rooms}</span>
									</div>
								</div>
							</Link>
						);
			...
			<div className="mb-10">
				<p className="font-bold sm:text-xl">See all 8 Ikoyi shared homes for rent</p>
			</div>
		</div>
	)
}

export default Ikoyi;
...
const Slider = () => {
  ...
  const prevSlide = () => {
    ...
    <div>
			<div className="pb-10">
				<Link href="/rent/apartments" className="flex items-center gap-3 text-xl font-bold">
			...
			<div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
				...
				<div className="flex flex-col gap-4">
					...
					<div className="border-1 border-gray-200 rounded-md px-4 py-6">
						...
						<div className="flex justify-between border-t border-gray-100 sm:p-4 p-2">
							<div className="flex flex-row items-center gap-1">
								...
								<span className="font-bold text-gray-400 text-xs sm:text-sm">145</span><p className="text-gray-400">sqft</p>
							</div>
							...
							<div className="flex flex-row items-center gap-1">
								...
								<span className="font-bold text-gray-400 text-xs sm:text-sm">2</span><p className="text-gray-400">parking</p>
							</div>
						</div>
					</div>
					{/* buttom */}
					<div className="border-1 border-gray-200 rounded-md px-4 py-6">
						...
						<p className="text-sm text-gray-400 leading-normal">Discover comfort in this fully services 3-bedroom apartment in the
							heart of Ikorodu, Lagos. Comes with fitted kitchen, tiled floors, and
							prepaid meter. Located in a gated estate with 24/7 security
						</p>
					</div>
				</div>
					...
					<div className="flex gap-6 py-4">
						<div className="flex gap-4 flex-col">
							<div className="flex gap-2 items-center">
								...
								<p>Ensuite bedrooms</p>
							</div>
							<div className="flex gap-2 items-center">
								<IoMdCheckmarkCircleOutline className="bg-green-200 rounded-md text-green-700 border-red-400 text-4xl px-2 py-2" />
								<p>Master bedroom with walk-in closet</p>
							</div>
							<div className="flex gap-2 items-center">
								<IoMdCheckmarkCircleOutline className="bg-green-200 rounded-md text-green-700 border-red-400 text-4xl px-2 py-2" />
							...
							<div className="flex gap-2 items-center">
								<IoMdCheckmarkCircleOutline className="bg-green-200 rounded-md text-green-700 border-red-400 text-4xl px-2 py-2" />
								<p>Marble & ceramics tile flooring</p>
							</div>
							<div className="flex gap-2 items-center">
								<IoMdCheckmarkCircleOutline className="bg-green-200 rounded-md text-green-700 border-red-400 text-4xl px-2 py-2" />
        ...
        {currentSlide < totalSlides - 1 && (
          ...
          >
            <FaAngleRight className="text-lg md:text-xl" />
				...
				<h1 className="my-10 text-xl font-bold text-black">see all 8 ikorodu apartments for sales</h1>
			</div>
    </div>
  )
}

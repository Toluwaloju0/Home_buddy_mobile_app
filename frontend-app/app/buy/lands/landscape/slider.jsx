...
const sliderImages = [
	...
	{
		image: "/assets/epe land_5.png"
	},
	{
		image: "/assets/epe land_6.png"
	},
	{
		image: "/assets/epe land_7.jpg"
	},
	{
		image: "/assets/epe land_8.jpg"
	},
]
...
const Slider = () => {
	...
	return (
		<div>
			<div className="pb-10">
				<Link href="/buy/lands" className="flex items-center gap-3 text-xl font-bold">
			...
			<div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
				...
				<div className="flex flex-col gap-4">
					...
					{/* buttom */}
					<div className="border-1 border-gray-200 rounded-md px-4 py-6">
						<p className="text-black uppercase font-bold mb-2 text-sm">About this land</p>
						<p className="text-sm text-gray-400 leading-normal">Premium 1634 square meters of residental land strategically
							located in the rapdly growing epe area of Lagos. This property comes with a Certificate of Occupancy (C of O), 
							ensuring clean, verifiable, and goverment approved title docuents. The land is completely dry, properly 
							leveled, and imediately ready for development.
						</p>
						<p className="text-sm text-gray-400 leading-normal">Perfect location for building your draem familty home, duplex, 
							or investent property. The neighborhood features similar high value properties and is ideal for those seekng tranquility
							while remaining close to urban amentites. Excellent capital appreciation potential with strong rental deed and in the area.
							...
							<div className="flex flex-col sm:flex-row border border-gray-200 rounded-xl sm:rounded-md p-4 w-full">
								...
								<div className="flex justify-center sm:justify-start mb-4 sm:mb-0 sm:mr-4">
									<div className="relative w-24 h-24 sm:w-28 sm:h-28">
										<Image src="/assets/agent-3.png" fill alt="image" className="w-full h-full object-cover rounded-full border-4 border-white shadow-md" />
									</div>
								</div>
			...
			<div className="my-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
				...
				<div className="border-2 border-gray-200 rounded-md px-4 py-6">
					...
					<div className="mb-5 flex flex-col gap-3">
						...
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Land size</p>
							<p>1634 square meters</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Dimension</p>
							<p>40m x 40.85m</p>
						</div>
						<div className="flex justify-between items-center">
						...
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Survey Plan</p>
							<p>Registered & Available</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Land Use</p>
							<p>Residential</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Topography</p>
							<p>Dry, Level & Sandy</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Fence Permit</p>
							<p>Available</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Payment Plan</p>
							<p>A6 month available</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Payment Terms</p>
							<p>30% deposit</p>
						</div><div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Price per sqm</p>
							<p>N50,000</p>
						</div>
						<div className="flex justify-between items-center">
				...
				<div className="flex flex-col gap-4">
					...
					{/* Required documents */}
					<div className="border-2 border-gray-200 rounded-md px-4 py-6">
						<p className="font-bold uppercase pb-3">required documents</p>
						<div>
							<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Valid ID</p>
							<p>Required</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Proof of Funds</p>
							<p>Required</p>
						</div>
						<div className="flex justify-between items-center">
							<p className="text-gray-400 capitalize">Inspection Fee</p>
							<p>Free</p>
						</div>
						</div>
					</div>
			...
			<div className="relative border-1 border-gray-200 mb-10 px-8 rounded-md">
				<h1 className="uppercase font-bold text-black my-5 text-xl">Nearby Lands</h1>
					...
					return (
						...
						{/* Property features - responsive layout */}
							<div className="flex justify-between border-t border-gray-100 p-4">
									...
									<div className="flex flex-row items-center gap-1">
										<ImFileOpenoffice className="text-gray-500 text-lg" />
										<span className="font-medium text-gray-700 text-xs sm:text-sm">{property.document}</span>
									</div>
							</div>
					</div>
					);
				...
				<h1 className="my-10 text-xl font-bold text-black">see all 10 Epe lands for sales</h1>
			</div>
		</div>
	)
}

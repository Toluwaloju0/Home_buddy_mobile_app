    ...
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-10">
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Yaba shops for sale</h1>
        </div>
      ...
      <div className="relative mb-10">
        ...
        >
          {visibleProperties.map((property, idx) => {
            ...
            return (
              <Link href="/buy/shops/properties"
			...
			<div className="mb-10">
				<p className="font-bold sm:text-xl">See all 11 Yaba shops for sale</p>
			</div>
    </div>
  )
}

		...
		<div>
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-10">
				<div className="mb-4 sm:mb-0">
					<h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Ikoyi apartments for sale</h1>
				</div>
			...
			<div className="mb-10">
				<p className="font-bold sm:text-xl">See all 20 Ikoyi apartments for sale</p>
			</div>
		</div>
	)
}

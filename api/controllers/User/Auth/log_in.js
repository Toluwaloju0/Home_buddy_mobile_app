...
const { UserService, RefreshService, TokenService } = services;
...
export default async function (request, response) {
  ...
  try {
    ...
    .cookie('token', TokenService.createToken(UserId), utils.CookieOptions)
    .cookie('refresh_token', await RefreshService.createRefreshToken(UserId), utils.CookieOptions)
